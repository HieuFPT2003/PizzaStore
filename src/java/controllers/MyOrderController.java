...
//        AccountDTO accountDTO = accountDAO.getAccountById(accountId);
        AccountDTO accountDTO = (AccountDTO) request.getSession().getAttribute("account");

        OrderDetailsDAO orderDetailsDAO = new OrderDetailsDAO();

        List<OrderDetailsDTO> orderDetails = orderDetailsDAO.getOrderDetailsByCustomerId(accountDTO.getCustomerId());

//        List<OrderDetailsDTO> orderDetails = orderDetailsDAO.getAllOrdersDetails();
